...
public class CuttingBoardGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public CuttingBoardGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(CookeryModMenus.CUTTING_BOARD_GUI.get(), id);
		...
		this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 142, 35) {
			@Override
