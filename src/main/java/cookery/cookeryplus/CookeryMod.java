...
@Mod("cookery")
public class CookeryMod {
	public static final Logger LOGGER = LogManager.getLogger(CookeryMod.class);
	public static final String MODID = "cookery";
