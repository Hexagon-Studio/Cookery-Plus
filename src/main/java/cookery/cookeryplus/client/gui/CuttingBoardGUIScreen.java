...
import cookery.cookeryplus.network.CuttingBoardGUIButtonMessage;
...
public class CuttingBoardGUIScreen extends AbstractContainerScreen<CuttingBoardGUIMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("cookery:textures/screens/cutting_board_gui.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Cutting Board", 51, 7, -12829636);
	}
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 87, this.topPos + 34, 40, 20, new TextComponent("Cut"), e -> {
			if (true) {
				CookeryMod.PACKET_HANDLER.sendToServer(new CuttingBoardGUIButtonMessage(0, x, y, z));
